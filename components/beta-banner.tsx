...
export default function BetaBanner() {
  return (
    <div className="w-full bg-gradient-to-r from-rose-600 via-red-500 to-orange-500 text-white text-[11px] sm:text-xs py-1.5 px-3 z-30 border-b border-orange-400/40 shrink-0">
